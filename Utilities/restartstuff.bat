...
TASKKILL /IM "NVIDIA RTX Voice.exe" /F
TIMEOUT /NOBREAK /T 2
START /MIN /B /D"C:\Program Files\NVIDIA Corporation\NVIDIA RTX Voice" "" "C:\Program Files\NVIDIA Corporation\NVIDIA RTX Voice\NVIDIA RTX Voice.exe"
